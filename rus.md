...
за неимением официального названия, я называю «обратная БЭМ-иерархия»: разделения по технологиям, 
а внутри них — по блокам:
...
Канонический Яндекс-вариант: разбирать css на блоки, складывая каждый в отдельную папку. 
