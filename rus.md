...
Вместо этого, мы исследуем несколько различных вариантов архитектур, которые
вы можете использовать с вашим любимым препроцессором, чтобы найди подходящую
...
Итак, что же мы имеем? CSS тяжело поддаётся программированию, так что мы не имеем
...
> Все архитектуры я начну с папки base. В ней я положу файлы, которые не
...
* Имеет смысл
* Вряд ли имеет повторяющиеся селекторы (отдельные блоки объявлений для одного и того же селектора) 

####Недостатки

* Можно запутаться, особенно если у вас много различных украшений
* Скрипты могут быть довольно объемными, в частности `_content.scss`
...
процесс современного веб-дизайнера»](http://css-tricks.com/video-screencasts/124-a-modern-web-designers-workflow/). Как и предполагает название данной
...
* Довольно неряшлива
* Можно получить повторяющиеся селекторы
...
Чуть ранее в этом году Хьюго [описал свою Sass архитектуру](http://www.sitepoint.com/architecture-sass-project/). Оказалось, это смесь
